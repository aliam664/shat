# =====================================================================
#  Uhm Graphics Pack v2 - Installer
...
try {
    ...
    $Host.UI.RawUI.WindowTitle = 'Uhm Graphics Pack v2 - Installer'
} catch {}
...
function Msg {
    param([string]$Text, [string]$Title = 'Uhm Graphics Pack v2', [string]$Icon = 'Information', [string]$Buttons = 'OK')
...
Write-Host '        Uhm Graphics Pack v2  -  نصب‌کننده هوشمند / نسخه ۲' -ForegroundColor Magenta
Write-Host '   ===============================================================' -ForegroundColor Magenta
Write-Host ''

Msg -Text ("به نصب‌کننده پک گرافیک Uhm نسخه ۲ خوش آمدید.`n`n" +
...
$dropDir = Join-Path $acRoot 'Uhm Pack v2 Presets'
...
$reportText = @(
    'Uhm Graphics Pack v2 - گزارش نصب',
