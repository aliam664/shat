...
:: =====================================================================
::
::   Install-Uhm-Pack-v5.bat
::   ------------------------
::   Uhm Graphics Pack v5 - Setup Launcher
::
...
title Uhm Graphics Pack v5 - Setup
cd /d "%~dp0"
...
echo.
echo  ================================================================
echo                Uhm Graphics Pack v5  -  Setup
echo  ================================================================
echo.
...
set "batchPath=%~f0"
> "%temp%\uhm_pack_v5_elevate.vbs" echo Set UAC = CreateObject^("Shell.Application"^)
>> "%temp%\uhm_pack_v5_elevate.vbs" echo UAC.ShellExecute "%batchPath%", "ELEV", "", "runas", 1
cscript //nologo "%temp%\uhm_pack_v5_elevate.vbs"
del /f /q "%temp%\uhm_pack_v5_elevate.vbs" >nul 2>&1
exit /b
...
echo.
echo  ================================================================
echo   Thank you for installing Uhm Graphics Pack v5.
